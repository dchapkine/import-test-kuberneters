				...
				Containers: []api.Container{
					{
						...
						Ports: []api.ContainerPort{
							{ContainerPort: 80, HostPort: 80, Protocol: api.ProtocolUDP, Name: "test"},
							{ContainerPort: 180, HostPort: 180, Protocol: api.ProtocolUDP},
							{ContainerPort: 8080, HostPort: 8080, Protocol: api.ProtocolUDP, Name: "test1"},
						},
					},
					{
						Name: "foo",
						Ports: []api.ContainerPort{
							{ContainerPort: 8090, HostPort: 8090, Protocol: api.ProtocolUDP, Name: "test2"},
							{ContainerPort: 8092, HostPort: 8092, Protocol: api.ProtocolUDP, Name: "test"},
						},
					}},
			}},
			oldTemplate: &api.PodTemplateSpec{Spec: api.PodSpec{
			...
			template: &api.PodTemplateSpec{Spec: api.PodSpec{
				InitContainers: []api.Container{
					...
					},
					{
						...
						RestartPolicy: &containerRestartPolicyAlways,
						Ports: []api.ContainerPort{
							{ContainerPort: 8090, HostPort: 8090, Protocol: api.ProtocolUDP, Name: "test1"},
