...
func TestGetReplicaCountForReplicaSets(t *testing.T) {
	rs1 := generateRSWithReplicas(generateDeployment("foo"), 1, apps.ReplicaSetStatus{Replicas: 2, TerminatingReplicas: ptr.To[int32](3)})
	rs2 := generateRSWithReplicas(generateDeployment("bar"), 2, apps.ReplicaSetStatus{Replicas: 3, TerminatingReplicas: ptr.To[int32](1)})
...
func TestNewRSNewReplicasWithTerminationCompleteDeploymentPodReplacementPolicy(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			replicaSets: []*apps.ReplicaSet{
				ptr.To(generateRSWithReplicas(generateDeployment("nginx"), 1, apps.ReplicaSetStatus{TerminatingReplicas: ptr.To[int32](1)})),
				ptr.To(generateRSWithReplicas(generateDeployment("nginx"), 1, apps.ReplicaSetStatus{TerminatingReplicas: ptr.To[int32](1)})),
				ptr.To(generateRSWithReplicas(generateDeployment("nginx"), 0, apps.ReplicaSetStatus{Replicas: 1, TerminatingReplicas: ptr.To[int32](2)})),
			},
			expected: 1,
		},
		{
			...
			replicaSets: []*apps.ReplicaSet{
				ptr.To(generateRSWithReplicas(generateDeployment("nginx"), 1, apps.ReplicaSetStatus{})), // unsynced
				ptr.To(generateRSWithReplicas(generateDeployment("nginx"), 1, apps.ReplicaSetStatus{TerminatingReplicas: ptr.To[int32](2)})),
				ptr.To(generateRSWithReplicas(generateDeployment("nginx"), 0, apps.ReplicaSetStatus{Replicas: 1, TerminatingReplicas: ptr.To[int32](2)})),
			},
			expected: 1,
		},
		{
			...
			replicaSets: []*apps.ReplicaSet{
				ptr.To(generateRSWithReplicas(generateDeployment("nginx"), 1, apps.ReplicaSetStatus{TerminatingReplicas: ptr.To[int32](2)})),
				ptr.To(generateRSWithReplicas(generateDeployment("nginx"), 0, apps.ReplicaSetStatus{TerminatingReplicas: ptr.To[int32](2)})),
				ptr.To(generateRSWithReplicas(generateDeployment("nginx"), 0, apps.ReplicaSetStatus{TerminatingReplicas: ptr.To[int32](3)})),
			},
			expected: 1,
		},
		{
			...
			replicaSets: []*apps.ReplicaSet{
				ptr.To(generateRSWithReplicas(generateDeployment("nginx"), 1, apps.ReplicaSetStatus{Replicas: 1, TerminatingReplicas: ptr.To[int32](1)})),
				ptr.To(generateRSWithReplicas(generateDeployment("nginx"), 0, apps.ReplicaSetStatus{Replicas: 1, TerminatingReplicas: ptr.To[int32](1)})),
				ptr.To(generateRSWithReplicas(generateDeployment("nginx"), 0, apps.ReplicaSetStatus{TerminatingReplicas: ptr.To[int32](1)})),
			},
			expected: 5,
		},
		{
...
func TestAnnotationUtils(t *testing.T) {
	for _, testScaleVersion := range []string{"v1", "v2"} {
		for _, podReplacementPolicyFG := range []bool{true, false} {
			...
			t.Run(fmt.Sprintf("TestAnnotationUtils with podReplacementPolicyFG=%v and with %v scaling", podReplacementPolicyFG, testScaleVersion), func(t *testing.T) {
	...
	for _, testScaleVersion := range []string{"v1", "v2"} {
		for _, podReplacementPolicyFG := range []bool{true, false} {
			for _, test := range tests {
				...
				t.Run(test.name+fmt.Sprintf("with podReplacementPolicyFG=%v and with %v scaling", podReplacementPolicyFG, testScaleVersion), func(t *testing.T) {
					featuregatetesting.SetFeatureGateDuringTest(t, utilfeature.DefaultFeatureGate, features.DeploymentPodReplacementPolicy, podReplacementPolicyFG)
